...
(function () {
  ...
  Dashboard = React.createClass({
    ...
    render: function () {
      return React.createElement("div", {
        ...
        "bool": this.props.flag.show_profile
      }, React.createElement(ProfileBox, {
        "user": this.props.user,
        "profile": this.props.profile,
        "url": "/api/users/" + this.props.user.uid + "/profile"
      })), React.createElement(If, {
        "bool": this.props.flag.show_users
  ...
  UsersBox = React.createClass({
    ...
    componentDidMount: function () {
      return console.log("UsersBox");
    },
    render: function () {
      return React.createElement("div", {
        "className": "usersBox flex flex-xs-8"
      }, React.createElement("div", {
        "className": "frame z1"
      }, React.createElement("h1", null, "ユーザー一覧"), "これはUsersBoxです。"));
    }
  });
  ...
  ProfileBox = React.createClass({
    ...
    handleEdit: function () {
      if ($("#profileBox").hasClass("edit")) {
        ...
        return $("#profileBox").removeClass("edit");
      } else {
        return $("#profileBox").addClass("edit");
      }
    },
    handleBioChange: function (e) {
      return this.setState({
        bio: e.target.value.replace(/\s+/g, "")
      });
    },
    render: function () {
      return React.createElement("div", {
        "id": "profileBox",
        "className": "flex flex-xs-6"
      }, React.createElement("div", {
        "className": "frame z1"
      }, React.createElement("div", {
        "className": "header"
        ...
        "className": "mask"
      }, React.createElement(Center, null, React.createElement("i", {
        "className": "fa fa-camera"
      })))), React.createElement("div", {
        "className": "content"
      }, React.createElement("div", {
        "className": "bio"
      }, this.state.bio), React.createElement("textarea", {
        ...
        "className": "posts data flex-xs-auto"
      }, React.createElement("div", {
        "className": "column"
      }, React.createElement("div", {
        "className": "name"
        ...
        "className": "follows data flex-xs-auto"
      }, React.createElement("div", {
        "className": "column"
      }, React.createElement("div", {
        "className": "name"
        ...
        "className": "followers data flex-xs-auto"
      }, React.createElement("div", {
        "className": "column"
      }, React.createElement("div", {
        "className": "name"
  ...
  CommentList = React.createClass({
    ...
    render: function () {
      return React.createElement("div", {
        ...
        "author": "taneichi"
      }, "たねいちです"), React.createElement(Comment, {
        "author": "nakano"
      }, "*another*だよ"), "Hello, world! I am a CommentList.");
    }
  });
  ...
  Profile = React.createClass({
    ...
    websocket: function () {
      ...
      ws_rails.bind("websocket_profile", function (message) {
        var message_li;
        message_li = document.createElement("li");
        message_li.textContent = message;
        return document.getElementById("chat_area").appendChild(message_li);
      });
      return document.getElementById("send").onclick = function () {
        var comment;
        comment = document.getElementById("comment").value;
        document.getElementById("comment").value = "";
        return ws_rails.trigger("websocket_profile", comment);
      };
    },
    render: function () {
